...
@Generated(
    ...
    date = "2022-11-13T20:57:56+0100",
    comments = "version: 1.5.2.Final, compiler: IncrementalProcessingEnvironment from gradle-language-java-7.4.jar, environment: Java 18.0.2.1 (Oracle Corporation)"
)
@Component
public class ImagePostMapperImpl implements ImagePostMapper {
    ...
    public ImagePost fromDTO(ImagePostDTO dto) {
        ...
        imagePost.setPublicationTime( dto.getPublicationTime() );
    ...
    public ImagePostDTO toDTO(ImagePost BO) {
        ...
        imagePostDTO.setPublicationTime( BO.getPublicationTime() );
